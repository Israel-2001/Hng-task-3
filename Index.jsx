...
export default function SignIn() {
  ...
  async function onSubmit(e){
    ...
    try {
      ...
      toast.success("Right User Credentials")
    } catch (error) {
    ...
    <section>
      <h1 
        className="text-3xl text-center
         mt-6 font-bold text-white">Sign In
      </h1>
      <div 
        ...
        <div  
          ...
          <form onSubmit={onSubmit}>
            ...
            <div 
              ...
              <p className="mb-6 text-white">Don't have a account? 
                <Link className="text-red-600 hover:text-red-700 
                  transition duration-200  ease-out ml-1" 
                  to="/sign-up"
                >
                  Register
                </Link>
